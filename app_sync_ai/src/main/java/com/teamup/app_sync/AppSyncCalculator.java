...
public class AppSyncCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppSyncFullScreenView.FullScreencall(AppSyncCalculator.this);
    ...
    private void ifErrorOnOutput() {
        if (t2.getText().toString().equals("Wrong Input")) {
            t2.setText("");
        }
    }
    ...
    private void noOperation() {
        ...
        if (!inputExpression.isEmpty() && !inputExpression.equals("Wrong Input")) {
